...
Deno.test({
    ...
    fn: function () {
        const message = new Message(new Uint8Array([8, 0x10, 0, 1,7,0x56,32,0,0,0]));
...
Deno.test({
    ...
    fn: function () {
        ...
        test.assertEquals(message.toUint8Array(), new Uint8Array([12,34,56,78]), "failed write ip address")
    }
})
...
Deno.test({
    ...
    fn: function () {
        ...
        test.assertEquals(message.readAddress(), "127.0.0.1", "failed read ip address")
    }
})